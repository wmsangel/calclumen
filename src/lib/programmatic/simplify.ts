...
const NOTABLE: [number, number][] = [
  ...
  // Common reducible fractions with denominators above 24 (people search these
  // a lot; the systematic grid only reaches denominator 24).
  [24, 36], [30, 45], [36, 48], [40, 60], [48, 64], [30, 40], [27, 36],
  [32, 48], [42, 56], [44, 66], [60, 80], [25, 35], [24, 32], [35, 49],
  [36, 54], [40, 50], [45, 72], [50, 60], [48, 72], [28, 42], [54, 72],
  [63, 72], [21, 35], [14, 35], [22, 33], [26, 39], [33, 44], [16, 28],
  [45, 54], [56, 64], [42, 63], [39, 52], [26, 65], [34, 51], [38, 57],
];
